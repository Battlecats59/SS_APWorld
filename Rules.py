...
class SSLogic(LogicMixin):
    ...
    def _ss_sword_requirement_met(self, player: int) -> bool:
        return(
            (
                ...
                and self.multiworld.worlds[player].options.got_sword_requirement == "goddess_sword"
            )
            or (
                has_goddess_longsword(self, player)
                and self.multiworld.worlds[player].options.got_sword_requirement == "goddess_longsword"
            )
            or (
                has_goddess_white_sword(self, player)
                and self.multiworld.worlds[player].options.got_sword_requirement == "goddess_white_sword"
            )
            or (
                has_master_sword(self, player)
                and self.multiworld.worlds[player].options.got_sword_requirement == "master_sword"
            )
            or (
                has_true_master_sword(self, player)
                and self.multiworld.worlds[player].options.got_sword_requirement == "true_master_sword"
            )
        )
    
    def _ss_can_beat_required_dungeons(self, player: int) -> bool:
        req_dungeon_checks = self.multiworld.worlds[player].dungeons.required_dungeon_checks
    ...
    def _ss_option_lake_floria_yerbal(self, player: int) -> bool:
        return self.multiworld.worlds[player].options.open_lake_floria == "talk_to_yerbal"
...
def set_rules(world: "SSWorld") -> None:
    ...
    def set_rule_if_progression(loc: str, rule: Callable[[CollectionState], bool]) -> None:
    ...
    set_rule_if_progression(
        ...
        lambda state: distance_activator(state, player) or state.has("Gust Bellows", player)
    )
    set_rule_if_progression("Upper Skyloft - Chest near Goddess Statue", lambda state: True)
    set_rule_if_progression("Upper Skyloft - First Goddess Sword Item in Goddess Statue", lambda state: True)
    set_rule_if_progression("Upper Skyloft - Second Goddess Sword Item in Goddess Statue", lambda state: True)
    set_rule_if_progression("Upper Skyloft - In Zelda's Closet", lambda state: state.has("Clawshots", player))
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        ...
        lambda state: has_bottle(state, player) and unlocked_endurance_potion(state, player)
    )
    set_rule_if_progression("Upper Skyloft - Item from Cawlin", lambda state: state.has("Goddess Harp", player))
    set_rule_if_progression("Upper Skyloft - Ghost/Pipit's Crystals", lambda state: state.has("Cawlin's Letter", player))
    set_rule_if_progression("Upper Skyloft - Pumpkin Archery -- 600 Points", lambda state: has_bow(state, player))
    ...
    set_rule_if_progression("Central Skyloft - Waterfall Cave First Chest", lambda state: can_cut_trees(state, player))
    set_rule_if_progression("Central Skyloft - Waterfall Cave Second Chest", lambda state: can_cut_trees(state, player))
    set_rule_if_progression("Central Skyloft - Rupee Waterfall Cave Crawlspace", lambda state: can_cut_trees(state, player))
    set_rule_if_progression("Central Skyloft - Parrow's Gift", lambda state: True)
    set_rule_if_progression("Central Skyloft - Parrow's Crystals", lambda state: can_save_orielle(state, player))
    set_rule_if_progression("Central Skyloft - Peater/Peatrice's Crystals", lambda state: True)
    set_rule_if_progression(
        "Central Skyloft - Item in Bird Nest",
        lambda state: state.has("Clawshots", player) and state.has("Gust Bellows", player)
    )
    set_rule_if_progression("Central Skyloft - Shed Chest", lambda state: state.has("Water Dragon's Scale", player))
    set_rule_if_progression(
    ...
    set_rule_if_progression("Skyloft Village - Mallara's Crystals", lambda state: state.has("Gust Bellows", player))
    set_rule_if_progression("Skyloft Village - Bertie's Crystals", lambda state: state.has("Baby Rattle", player))
    set_rule_if_progression(
        "Skyloft Village - Sparrot's Crystals",
        lambda state: can_reach_second_part_of_eldin_volcano(state, player)
        and state.has("Clawshots", player) and state.has("Scrapper", player)
    )

    set_rule_if_progression("Batreaux's House - 5 Crystals", lambda state: five_gratitude_crystals(state, player))
    set_rule_if_progression("Batreaux's House - 10 Crystals", lambda state: ten_gratitude_crystals(state, player))
    set_rule_if_progression("Batreaux's House - 30 Crystals", lambda state: thirty_gratitude_crystals(state, player))
    set_rule_if_progression("Batreaux's House - 30 Crystals Chest", lambda state: thirty_gratitude_crystals(state, player))
    set_rule_if_progression("Batreaux's House - 40 Crystals", lambda state: forty_gratitude_crystals(state, player))
    set_rule_if_progression("Batreaux's House - 50 Crystals", lambda state: fifty_gratitude_crystals(state, player))
    set_rule_if_progression("Batreaux's House - 70 Crystals", lambda state: seventy_gratitude_crystals(state, player))
    set_rule_if_progression("Batreaux's House - 70 Crystals Second Reward", lambda state: seventy_gratitude_crystals(state, player))
    set_rule_if_progression("Batreaux's House - 80 Crystals", lambda state: eighty_gratitude_crystals(state, player))

    set_rule_if_progression(
        "Beedle's Shop - 300 Rupee Item",
        lambda state: can_access_beedles_shop(state, player) and can_afford_300_rupees(state, player)
        and (has_pouch(state, player) or state._ss_option_shopsanity(player))
    )
    set_rule_if_progression(
        "Beedle's Shop - 600 Rupee Item",
        lambda state: can_access_beedles_shop(state, player) and can_afford_600_rupees(state, player)
        and (has_pouch(state, player) or state._ss_option_shopsanity(player))
    )
    set_rule_if_progression(
        "Beedle's Shop - 1200 Rupee Item",
        lambda state: can_access_beedles_shop(state, player) and can_afford_1200_rupees(state, player)
        and (has_pouch(state, player) or state._ss_option_shopsanity(player))
    )
    set_rule_if_progression(
        "Beedle's Shop - 800 Rupee Item",
        lambda state: can_access_beedles_shop(state, player) and can_afford_800_rupees(state, player)
    )
    set_rule_if_progression(
        "Beedle's Shop - 1600 Rupee Item",
        lambda state: can_access_beedles_shop(state, player) and can_afford_1600_rupees(state, player)
    )
    set_rule_if_progression("Beedle's Shop - First 100 Rupee Item", lambda state: can_access_beedles_shop(state, player))
    set_rule_if_progression("Beedle's Shop - Second 100 Rupee Item", lambda state: can_access_beedles_shop(state, player))
    set_rule_if_progression(
        "Beedle's Shop - Third 100 Rupee Item",
        lambda state: can_access_beedles_shop(state, player) and can_medium_rupee_farm(state, player)
    )
    set_rule_if_progression("Beedle's Shop - 50 Rupee Item", lambda state: can_access_beedles_shop(state, player))
    set_rule_if_progression(
        "Beedle's Shop - 1000 Rupee Item",
        lambda state: can_access_beedles_shop(state, player) and can_afford_1000_rupees(state, player)
    )

    set_rule_if_progression("Sky - Lumpy Pumpkin - Chandelier", lambda state: True)
    set_rule_if_progression(
        "Sky - Lumpy Pumpkin - Harp Minigame",
        lambda state: state.has("Goddess's Harp", player) and has_bottle(state, player) # Bottle for soup quest
    )
    set_rule_if_progression(
        "Sky - Kina's Crystals",
        lambda state: state.has("Scrapper", player) and has_bottle(state, player)
        and state.can_reach_region("Mogma Turf", player)
    )
    set_rule_if_progression("Sky - Orielle's Crystals", lambda state: can_save_orielle(state, player))
    set_rule_if_progression(
        "Sky - Beedle's Crystals",
        lambda state: can_access_beedles_shop(state, player) and state.has("Horned Colossus Beetle", player)
    )
    set_rule_if_progression("Sky - Dodoh's Crystals", lambda state: can_retrieve_party_wheel(state, player))
    set_rule_if_progression("Sky - Fun Fun Island Minigame -- 500 Rupees", lambda state: can_retrieve_party_wheel(state, player))
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        ...
        lambda state: goddess_cube_on_east_great_tree_with_clawshot_target(state, player)
        and state.has("Clawshots", player)
    )
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        ...
        lambda state: can_access_thunderhead(state, player) and has_goddess_sword(state, player)
    )
    set_rule_if_progression(
        "Thunderhead - Isle of Songs - Strike Crest with Longsword",
        lambda state: can_access_thunderhead(state, player) and has_goddess_longsword(state, player)
    )
    set_rule_if_progression(
        "Thunderhead - Isle of Songs - Strike Crest with White Sword",
        lambda state: can_access_thunderhead(state, player) and has_goddess_white_sword(state, player)
    )
    set_rule_if_progression(
        "Thunderhead - Song from Levias",
        lambda state: can_access_thunderhead(state, player) and has_practice_sword(state, player)
        and state.has("Scrapper", player) and state.has("Spiral Charge", player)
    )
    set_rule_if_progression(
        "Thunderhead - Bug Heaven -- 10 Bugs in 3 Minutes",
        lambda state: can_access_thunderhead(state, player) and has_bug_net(state, player)
    )
    set_rule_if_progression(
        "Thunderhead - East Island Chest",
        lambda state: can_access_thunderhead(state, player) and has_digging_mitts(state, player)
    )
    set_rule_if_progression(
        "Thunderhead - East Island Goddess Chest",
        lambda state: can_access_thunderhead(state, player) and goddess_cube_on_east_great_tree_with_rope(state, player)
    )
    set_rule_if_progression(
        "Thunderhead - Goddess Chest on top of Isle of Songs",
        lambda state: can_access_thunderhead(state, player) and goddess_cube_near_fire_sanctuary_entrance(state, player)
    )
    set_rule_if_progression(
        "Thunderhead - Goddess Chest outside Isle of Songs",
        lambda state: can_access_thunderhead(state, player) and goddess_cube_in_mogma_turf(state, player)
    )
    set_rule_if_progression(
        "Thunderhead - First Goddess Chest on Mogma Mitts Island",
        lambda state: can_access_thunderhead(state, player) and goddess_cube_inside_volcano_summit(state, player)
        and has_mogma_mitts(state, player)
    )
    set_rule_if_progression(
        "Thunderhead - Second Goddess Chest on Mogma Mitts Island",
        lambda state: can_access_thunderhead(state, player) and goddess_cube_in_lanayru_gorge(state, player)
        and has_mogma_mitts(state, player)
    )
    set_rule_if_progression(
        "Thunderhead - Bug Heaven Goddess Chest",
        lambda state: can_access_thunderhead(state, player) and goddess_cube_in_summit_waterfall(state, player)
    )
    ...
    set_rule_if_progression(
        ...
        lambda state: can_reach_sealed_temple(state, player) and state.has("Goddess's Harp", player)
    )
    set_rule_if_progression(
        "Sealed Grounds - Gorko's Goddess Wall Reward",
        lambda state: can_reach_sealed_temple(state, player) and state.has("Goddess's Harp", player)
        and state.has("Ballad of the Goddess", player) and has_goddess_sword(state, player)
    )
    set_rule_if_progression(
        "Sealed Grounds - Zelda's Blessing",
        lambda state: can_reach_past(state, player)
    )

    # Faron Woods
    set_rule_if_progression(
        "Faron Woods - Item behind Lower Bombable Rock",
        lambda state: can_reach_most_of_faron_woods(state, player) and state.has("Bomb Bag", player)
    )
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        ...
        lambda state: can_reach_most_of_faron_woods(state, player) and can_defeat_bokoblins(state, player)
    ...
    set_rule_if_progression(
        ...
        lambda state: can_reach_most_of_faron_woods(state, player) and has_beetle(state, player)
    )
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        ...
        lambda state: (can_reach_great_tree(state, player) and state.has("Gust Bellows", player))
        or (can_reach_top_of_great_tree(state, player) and can_defeat_moblins(state, player))
    )
    set_rule_if_progression(
        "Faron Woods - Rupee on Great Tree North Branch",
        lambda state: can_reach_top_of_great_tree(state, player) and has_beetle(state, player)
    )
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        ...
        lambda state: can_reach_floria_waterfall(state, player) and state.has("Water Dragon's Scale", player)
    )
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        ...
        lambda state: can_reach_floria_waterfall(state, player) and has_beetle(state, player)
    )

    # Flooded Faron Woods
    set_rule_if_progression(
        "Flooded Faron Woods - Yellow Tadtone under Lilypad",
        lambda state: can_access_flooded_faron_woods(state, player) and state.has("Water Dragon's Scale", player)
    )
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        ...
        lambda state: can_access_flooded_faron_woods(state, player) and state.has("Group of Tadtones", player, 17)
    )
    ...
    set_rule_if_progression(
        ...
        lambda state: can_access_eldin_volcano(state, player) and has_beetle(state, player)
    )
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        ...
        lambda state: can_reach_second_part_of_eldin_volcano(state, player) and has_digging_mitts(state, player)
    )
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        ...
        lambda state: can_reach_second_part_of_eldin_volcano(state, player) and has_digging_mitts(state, player)
        and (can_survive_eldin_hot_cave(state, player) or state.has("Bomb Bag", player))
    )
    ...
    set_rule_if_progression(
        ...
        lambda state: can_access_mogma_turf(state, player) and can_defeat_bokoblins(state, player)
    )
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        ...
        lambda state: can_access_volcano_summit(state, player) and state.has("Clawshots", player)
    )
    set_rule_if_progression(
        "Volcano Summit - Item behind Digging",
        lambda state: can_pass_volcano_summit_first_frog(state, player) and has_mogma_mitts(state, player)
    )
    ...
    set_rule_if_progression(
        ...
        lambda state: can_access_bokoblin_base(state, player) and has_mogma_mitts(state, player)
    )
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        ...
        lambda state: can_access_bokoblin_base(state, player) and has_mogma_mitts(state, player)
        and (state.has("Clawshots", player) or can_bypass_boko_base_watchtower(state, player))
    )
    set_rule_if_progression(
        ...
        and (
            ...
            or (can_bypass_boko_base_watchtower(state, player) and state.has("Whip", player))
        )
    )
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        ...
        lambda state: can_access_bokoblin_base(state, player) and has_mogma_mitts(state, player)
        and state.has("Clawshots", player) and state.has("Bomb Bag", player)
    ...
    set_rule_if_progression(
        ...
        lambda state: can_access_bokoblin_base(state, player) and has_mogma_mitts(state, player)
        and state.has("Clawshots", player) and state.has("Bomb Bag", player)
        and state.has("Fireshield Earrings", player) and has_practice_sword(state, player)
    )
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        ...
        lambda state: can_access_lanayru_mine(state, player) and state.has("Clawshots", player)
    )
    set_rule_if_progression(
        "Lanayru Mine - Chest near First Timeshift Stone",
        lambda state: can_access_lanayru_mine(state, player) and can_hit_timeshift_stone(state, player)
    )
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        ...
        lambda state: can_access_lanayru_desert(state, player) and state.has("Bomb Bag", player)
    )
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        ...
        lambda state: can_reach_second_part_of_lanayru_desert(state, player) and state.has("Clawshots", player)
    )
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        ...
        lambda state: can_access_lanayru_desert(state, player) and state.has("Clawshots", player)
    )
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        ...
        lambda state: can_reach_second_part_of_lanayru_desert(state, player) and can_defeat_ampilus(state, player)
    )
    set_rule_if_progression(
        "Lanayru Desert - First Small Chest",
        lambda state: can_reach_second_part_of_lanayru_desert(state, player) and state.has("Bomb Bag", player)
    )
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        ...
        lambda state: can_reach_second_part_of_lanayru_desert(state, player) and can_defeat_ampilus(state, player)
        and state.has("Bomb Bag", player) and has_hook_beetle(state, player)
    )
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        ...
        lambda state: can_access_lanayru_caves(state, player) and state.has("Clawshots", player)
    )
    
    # Lanayru Gorge
    set_rule_if_progression(
        "Lanayru Gorge - Thunder Dragon's Reward",
        lambda state: can_access_lanayru_gorge(state, player) and can_hit_timeshift_stone(state, player)
        and state.has("Life Tree Fruit", player)
    )
    set_rule_if_progression(
        "Lanayru Gorge - Item on Pillar",
        lambda state: can_access_lanayru_gorge(state, player) and has_beetle(state, player)
    )
    set_rule_if_progression(
        "Lanayru Gorge - Digging Spot",
        lambda state: can_access_lanayru_gorge(state, player) and can_hit_timeshift_stone(state, player)
        and state.has("Gust Bellows", player) and has_digging_mitts(state, player)
    )

    # Lanayru Sand Sea
    set_rule_if_progression(
        "Lanayru Sand Sea - Ancient Harbour - Rupee on First Pillar",
        lambda state: can_access_lanayru_sand_sea(state, player) and has_beetle(state, player)
    )
    set_rule_if_progression(
        "Lanayru Sand Sea - Ancient Harbour - Left Rupee on Entrance Crown",
        lambda state: can_access_lanayru_sand_sea(state, player) and has_quick_beetle(state, player)
    )
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        ...
        lambda state: can_access_lanayru_sand_sea(state, player)
        and state.has("Whip", player) and state.has("Clawshots", player)
        and (state.has("Bomb Bag", player) or has_hook_beetle(state, player))
        and (
    ...
    set_rule_if_progression(
        ...
        and distance_activator(state, player) # Sword for fight, or scale to skip fight in SV 2
        and (has_practice_sword(state, player) or state.has("Water Dragon's Scale", player))
    )
    set_rule_if_progression(
        "Skyview - Item behind Bars",
        lambda state: can_reach_SV_main_room(state, player)
        and (has_beetle(state, player) or state.has("Whip", player)) # Beetle for crystal or whip item
    )
    set_rule_if_progression(
        "Skyview - Rupee in Southeast Tunnel",
        lambda state: can_reach_SV_main_room(state, player) and has_beetle(state, player)
    )
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        ...
        lambda state: can_reach_SV_boss_door(state, player)
        and (upgraded_skyward_strike(state, player) or distance_activator(state, player)) # to hit vines
    )
    set_rule_if_progression(
        "Skyview - Heart Container",
        lambda state: can_beat_ghirahim_1(state, player)
    )
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        "Skyview - Strike Crest",
        lambda state: can_beat_SV(state, player)
    )

    # Earth Temple
    set_rule_if_progression(
        "Earth Temple - Vent Chest",
        lambda state: state.can_reach_region("Earth Temple", player) and has_digging_mitts(state, player)
    )
    set_rule_if_progression(
        "Earth Temple - Rupee above Drawbridge",
        lambda state: state.can_reach_region("Earth Temple", player) and has_beetle(state, player)
    )
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        ...
        lambda state: can_reach_ET_main_room(state, player) and can_defeat_lezalfos(state, player)
    )
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        ...
        lambda state: can_beat_scaldera(state, player)
    )
    set_rule_if_progression(
        "Earth Temple - Strike Crest",
        lambda state: can_beat_ET(state, player)
    )
    ...
    set_rule_if_progression(
        ...
        lambda state: can_reach_LMF_second_room(state, player) and state.has("Gust Bellows", player)
    )
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        ...
        lambda state: can_reach_LMF_key_locked_room_in_past(state, player)
        and (
            distance_activator(state, player) or has_practice_sword(state, player)
            or state.has("Gust Bellows", player) or state.has("Whip", player)
    ...
    set_rule_if_progression(
        ...
        lambda state: can_reach_LMF_hub_room_west(state, player) and state.has("Gust Bellows", player)
    )
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        ...
        lambda state: state.can_reach_region("Ancient Cistern", player) and state.has("Water Dragon's Scale", player)
    )
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        ...
        lambda state: state.can_reach_region("Ancient Cistern", player) and state.has("Whip", player)
    )
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        ...
        lambda state: can_reach_AC_boko_key_door(state, player) and state.has("Whip", player)
    )
    set_rule_if_progression(
        "Ancient Cistern - Rupee under Lilypad",
        lambda state: can_reach_AC_boko_key_door(state, player) and state.has("Ancient Cistern Small Key", player, 2)
        and state.has("Water Dragon's Scale", player) and state.has("Whip", player)
    )
    set_rule_if_progression(
        ...
        and (can_defeat_stalmaster(state, player) or can_lower_AC_statue(state, player))
    )
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        ...
        lambda state: can_beat_AC(state, player)
    )

    # Sandship
    set_rule_if_progression(
        "Sandship - Chest at the Stern",
        lambda state: can_change_SSH_temporality(state, player) and has_bow(state, player)
        and state.has("Clawshots", player)
    )
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        ...
        and (
            (can_reach_SSH_4_door_corridor(state, player) and state.has("Gust Bellows", player))
    ...
    set_rule_if_progression(
        ...
        lambda state: can_beat_tentalus(state, player)
    )
    set_rule_if_progression(
        "Sandship - Nayru's Flame",
        lambda state: can_beat_SSH(state, player)
    )

    # Fire Sanctuary
    set_rule_if_progression(
        "Fire Sanctuary - Chest in First Room",
        lambda state: state.can_reach_region("Fire Sanctuary", player) and distance_activator(state, player)
    ...
    set_rule_if_progression(
        ...
        lambda state: can_reach_FS_plats_room(state, player) and has_mogma_mitts(state, player)
    )
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        ...
        lambda state: can_reach_top_of_FS_staircase(state, player) and has_mogma_mitts(state, player)
    )
    set_rule_if_progression(
    ...
    set_rule_if_progression(
        ...
        lambda state: can_beat_FS(state, player)
    )
