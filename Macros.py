...
def upgraded_skyward_strike(state: CollectionState, player: int) -> bool:
    return(
        has_true_master_sword(state, player)
        or (state._ss_option_upgraded_skyward_strike(player) and has_goddess_sword(state, player))
    )
...
def damaging_item(state: CollectionState, player: int) -> bool:
    return(
        has_practice_sword(state, player) or has_bow(state, player)
...
def can_unlock_combination_lock(state: CollectionState, player: int) -> bool:
    return(
        has_practice_sword(state, player) or has_bow(state, player)
        or state.has("Whip", player) or state.has("Clawshots", player)
    )
...
def can_hit_timeshift_stone(state: CollectionState, player: int) -> bool:
    return(
        ...
        or state.has("Whip", player) or state.has("Bomb Bag", player)
    )
...
def can_defeat_keeses(state: CollectionState, player: int) -> bool:
    return(
        damaging_item(state, player) or has_slingshot(state, player)
        or has_beetle(state, player) or state.has("Whip", player)
...
def can_obtain_10_loose_crystals(state: CollectionState, player: int) -> bool:
    return(
        can_access_central_skyloft(state, player) and can_access_sky(state, player)
        and (can_cut_trees(state, player) # 2 crystals past waterfall cave
             or state.has("Clawshots", player) # Zelda's room, atop waterfall
             or has_beetle(state, player)) # Sparring hall, beedle's island
    )
...
def ten_gratitude_crystals(state: CollectionState, player: int) -> bool:
    return(
        ...
        or (can_obtain_5_loose_crystals(state, player) and state.has("Gratitude Crystal Pack", player, 1))
        or state.has("Gratitude Crystal Pack", player)
    )

def thirty_gratitude_crystals(state: CollectionState, player: int) -> bool:
    return(
        (can_obtain_15_loose_crystals(state, player) and state.has("Gratitude Crystal Pack", player, 3))
        or (can_obtain_10_loose_crystals(state, player) and state.has("Gratitude Crystal Pack", player, 4))
        or (can_obtain_5_loose_crystals(state, player) and state.has("Gratitude Crystal Pack", player, 5))
        or state.has("Gratitude Crystal Pack", player, 6)
    )

def forty_gratitude_crystals(state: CollectionState, player: int) -> bool:
    return(
        (can_obtain_15_loose_crystals(state, player) and state.has("Gratitude Crystal Pack", player, 5))
        or (can_obtain_10_loose_crystals(state, player) and state.has("Gratitude Crystal Pack", player, 6))
        or (can_obtain_5_loose_crystals(state, player) and state.has("Gratitude Crystal Pack", player, 7))
        or state.has("Gratitude Crystal Pack", player, 8)
    )

def fifty_gratitude_crystals(state: CollectionState, player: int) -> bool:
    return(
        (can_obtain_15_loose_crystals(state, player) and state.has("Gratitude Crystal Pack", player, 7))
        or (can_obtain_10_loose_crystals(state, player) and state.has("Gratitude Crystal Pack", player, 8))
        or (can_obtain_5_loose_crystals(state, player) and state.has("Gratitude Crystal Pack", player, 9))
        or state.has("Gratitude Crystal Pack", player, 10)
    )

def seventy_gratitude_crystals(state: CollectionState, player: int) -> bool:
    return(
        (can_obtain_15_loose_crystals(state, player) and state.has("Gratitude Crystal Pack", player, 11))
        or (can_obtain_10_loose_crystals(state, player) and state.has("Gratitude Crystal Pack", player, 12))
        or (can_obtain_5_loose_crystals(state, player) and state.has("Gratitude Crystal Pack", player, 13))
    )

def eighty_gratitude_crystals(state: CollectionState, player: int) -> bool:
    return(
        (can_obtain_15_loose_crystals(state, player) and state.has("Gratitude Crystal Pack", player, 13))
    )
...
def can_afford_600_rupees(state: CollectionState, player: int) -> bool:
    return(
        ...
        and (has_big_wallet(state, player) or has_one_extra_wallet(state, player))
    )

def can_afford_800_rupees(state: CollectionState, player: int) -> bool:
    return(
        can_high_rupee_farm(state, player)
        and (has_big_wallet(state, player) or has_two_extra_wallets(state, player)
...
def can_afford_1000_rupees(state: CollectionState, player: int) -> bool:
    return(
        can_high_rupee_farm(state, player)
        and (has_big_wallet(state, player) or has_three_extra_wallets(state, player)
...
def can_afford_1200_rupees(state: CollectionState, player: int) -> bool:
    return(
        can_high_rupee_farm(state, player)
        and (has_giant_wallet(state, player) or has_three_extra_wallets(state, player)
...
def can_afford_1600_rupees(state: CollectionState, player: int) -> bool:
    return(
        can_high_rupee_farm(state, player)
        and (has_giant_wallet(state, player)
...
def can_reach_dungeon_entrance_on_skyloft(state: CollectionState, player: int) -> bool:
    return(
        ...
        and state.has("Stone of Trials", player) and state.has("Clawshots", player)
    )
...
def can_access_thunderhead(state: CollectionState, player: int) -> bool:
    return(
        (state._ss_option_thunderhead_ballad(player) and state.has("Ballad of the Goddess", player))
...
def can_access_hylias_realm(state: CollectionState, player: int) -> bool:
    return(
        can_reach_past(state, player)
        and (
            state._ss_option_no_triforce(player)
            or has_completed_triforce(state, player)
        )
    )
...
def can_reach_oolo(state: CollectionState, player: int) -> bool:
    return(
        (can_access_faron_woods(state, player) or can_access_flooded_faron_woods(state, player))
...
def can_reach_great_tree(state: CollectionState, player: int) -> bool:
    return can_reach_most_of_faron_woods(state, player) and state.has("Water Dragon's Scale", player)
...
def can_talk_to_yerbal(state: CollectionState, player: int) -> bool:
    return(
        ...
        and (has_slingshot(state, player) or has_beetle(state, player))
    )
...
def goddess_cube_on_east_great_tree_with_clawshot_target(state: CollectionState, player: int) -> bool:
    return(
        can_reach_most_of_faron_woods(state, player)
        and (state.has("Clawshots", player) or can_reach_top_of_great_tree(state, player))
        and has_goddess_sword(state, player)
    )

def goddess_cube_on_east_great_tree_with_rope(state: CollectionState, player: int) -> bool:
    return can_reach_top_of_great_tree(state, player) and has_goddess_sword(state, player)

def goddess_cube_on_west_great_tree_near_exit(state: CollectionState, player: int) -> bool:
    return can_reach_top_of_great_tree(state, player) and has_goddess_sword(state, player)
...
def can_reach_deep_woods_after_beehive(state: CollectionState, player: int) -> bool:
    return(
        can_access_deep_woods(state, player)
        and (
...
def can_reach_dungeon_entrance_in_deep_woods(state: CollectionState, player: int) -> bool:
    return can_reach_deep_woods_after_beehive(state, player) and distance_activator(state, player)

def initial_goddess_cube(state: CollectionState, player: int) -> bool:
    return can_reach_deep_woods_after_beehive(state, player) and has_goddess_sword(state, player)
...
def goddess_cube_on_top_on_skyview(state: CollectionState, player: int) -> bool:
    return(
        ...
        and state.has("Clawshots", player) and has_goddess_sword(state, player)
    )
...
def can_access_lake_floria(state: CollectionState, player: int) -> bool:
    return(
        ...
        and (
            ...
            or (can_talk_to_yerbal(state, player) and state._ss_option_lake_floria_yerbal(player))
...
def can_reach_dungeon_entrance_in_lake_floria(state: CollectionState, player: int) -> bool:
    return can_reach_floria_waterfall(state, player) and state.has("Water Dragon's Scale", player)
...
def can_survive_eldin_hot_cave(state: CollectionState, player: int) -> bool:
    return state.has("Fireshield Earrings", player) or state._ss_option_damage_multiplier_under_12(player)
...
def can_reach_dungeon_entrance_in_eldin_volcano(state: CollectionState, player: int) -> bool:
    return can_reach_second_part_of_eldin_volcano(state, player) and state.has("Key Piece", player, 5)
...
def goddess_cube_east_of_earth_temple_entrance(state: CollectionState, player: int) -> bool:
    return(
        (can_reach_second_part_of_eldin_volcano(state, player)
        or (
            can_access_bokoblin_base(state, player) and has_mogma_mitts(state, player)
            and state.has("Clawshots", player)
            and (
...
def goddess_cube_west_of_earth_temple_entrance(state: CollectionState, player: int) -> bool:
    return(
        ((can_reach_second_part_of_eldin_volcano(state, player) and has_digging_mitts(state, player))
        or (
            can_access_bokoblin_base(state, player) and has_mogma_mitts(state, player)
            and state.has("Clawshots", player)
            and (
...
def can_access_volcano_summit(state: CollectionState, player: int) -> bool:
    return can_reach_second_part_of_eldin_volcano(state, player) and state.has("Fireshield Earrings", player)
...
def can_pass_volcano_summit_second_frog(state: CollectionState, player: int) -> bool:
    return can_pass_volcano_summit_first_frog(state, player) and state.has("Clawshots", player)

def can_reach_dungeon_entrance_in_volcano_summit(state: CollectionState, player: int) -> bool:
    ...
    return(
        ...
        and (
            ...
            or (
                ...
                and has_mogma_mitts(state, player) and state.has("Clawshots", player)
                and state.has("Bomb Bag", player) and state.has("Fireshield Earrings", player)
            )
        )
        and has_goddess_sword(state, player)
    )
...
def goddess_cube_near_fire_sanctuary_entrance(state: CollectionState, player: int) -> bool:
    return(
...
def can_bypass_boko_base_watchtower(state: CollectionState, player: int) -> bool:
    return(
        state.has("Bomb Bag", player) or has_slingshot(state, player) or has_bow(state, player)
    )
...
def can_reach_second_part_of_lanayru_mine(state: CollectionState, player: int) -> bool:
    return(
        can_access_lanayru_mine(state, player) and can_hit_timeshift_stone(state, player)
        and (
            state.has("Bomb Bag", player) or has_hook_beetle(state, player)
...
def can_access_lanayru_desert(state: CollectionState, player: int) -> bool:
    return(
        can_reach_second_part_of_lanayru_mine(state, player)
        or (can_access_lanayru_mine(state, player) and state.has("Clawshots", player))
    )

def can_retrieve_party_wheel(state: CollectionState, player: int) -> bool:
    return(
        can_access_lanayru_desert(state, player)
        and state.has("Scrapper", player) and state.has("Bomb Bag", player)
    )

def can_reach_temple_of_time(state: CollectionState, player: int) -> bool:
    return(
        can_access_lanayru_desert(state, player)
        and (state.has("Clawshots", player) or has_hook_beetle(state, player))
    )

def can_reach_second_part_of_lanayru_desert(state: CollectionState, player: int) -> bool:
    return(
        can_access_lanayru_desert(state, player)
        and (
...
def can_activate_nodes(state: CollectionState, player: int) -> bool:
    return(
        ...
        and state.has("Bomb Bag", player) and has_practice_sword(state, player)
        and can_defeat_ampilus(state, player) and has_hook_beetle(state, player)
    )
...
def can_raise_lmf(state: CollectionState, player: int) -> bool:
    return(
        ...
        and (
            ...
            or (state._ss_option_lmf_main_node(player) and can_reach_second_part_of_lanayru_desert(state, player))
...
def can_reach_dungeon_entrance_in_lanayru_desert(state: CollectionState, player: int) -> bool:
    return can_raise_lmf(state, player)
...
def goddess_cube_at_ride_near_temple_of_time(state: CollectionState, player: int) -> bool:
    return can_reach_temple_of_time(state, player) and has_goddess_sword(state, player)
...
def can_access_lanayru_sand_sea(state: CollectionState, player: int) -> bool:
    return(
        can_access_lanayru_caves(state, player) and state.has("Lanayru Caves Small Key", player)
        and state.has("Clawshots", player)
    )

def can_reach_dungeon_entrance_in_lanayru_sand_sea(state: CollectionState, player: int) -> bool:
    return(
        can_access_lanayru_sand_sea(state, player)
        and state.has("Sea Chart", player) and has_practice_sword(state, player)
    )
...
def goddess_cube_in_pirate_stronghold(state: CollectionState, player: int) -> bool:
    return(
        can_access_lanayru_sand_sea(state, player)
        and can_defeat_beamos(state, player) and can_defeat_armos(state, player)
        and has_goddess_sword(state, player)
    )

# Ancient Flowers
def lanayru_mine_ancient_flower_farming(state: CollectionState, player: int) -> bool:
    return can_access_lanayru_mine(state, player) and can_hit_timeshift_stone(state, player)
...
def lanayru_desert_ancient_flower_farming_near_main_node(state: CollectionState, player: int) -> bool:
    return(
        can_reach_second_part_of_lanayru_desert(state, player)
        and (has_hook_beetle(state, player) or state.has("Bomb Bag", player))
    )

def pirate_stronghold_ancient_flower_farming(state: CollectionState, player: int) -> bool:
...
def lanayru_gorge_ancient_flower_farming(state: CollectionState, player: int) -> bool:
    return(
        can_access_lanayru_gorge(state, player)
        and state.has("Gust Bellows", player) and can_hit_timeshift_stone(state, player)
    )
...
def can_reach_SV_second_room(state: CollectionState, player: int) -> bool:
    return(
        ...
        and (
            ...
            or (distance_activator(state, player) and has_practice_sword(state, player)) # One eye room
        )
    )
...
def can_reach_SV_main_room(state: CollectionState, player: int) -> bool:
    return(
        ...
        and (
            ...
            or state.has("Whip", player) # Whip and goddess sword can hit vines in left room
        )
    )
...
def can_reach_SV_boss_door(state: CollectionState, player: int) -> bool:
    return(
        ...
        and (has_practice_sword(state, player) or state.has("Bomb Bag", player)) # Staldra fight
        and (
...
def can_reach_ET_main_room(state: CollectionState, player: int) -> bool:
    return(
        ...
        and can_lower_ET_drawbridge(state, player) and can_dislodge_ET_boulder(state, player)
    )
...
def can_reach_ET_boss_door(state: CollectionState, player: int) -> bool:
    return(
        can_pass_ET_boulder_section(state, player)
        and (
...
def can_reach_LMF_second_room(state: CollectionState, player: int) -> bool:
    return state.can_reach_region("Lanayru Mining Facility", player) and has_hook_beetle(state, player)
...
def can_reach_LMF_hub_room_west(state: CollectionState, player: int) -> bool:
    return(
        ...
        and can_defeat_beamos(state, player) and can_defeat_armos(state, player)
        and (
            has_goddess_sword(state, player) or has_slingshot(state, player)
            or has_bow(state, player) or state.has("Whip", player) # to hit timeshift stone
        )
    )

def can_reach_LMF_boss_door(state: CollectionState, player: int) -> bool:
    return can_reach_LMF_hub_room_west(state, player) and state.has("Gust Bellows", player)

def can_pass_LMF_boss_key_room(state: CollectionState, player: int) -> bool:
    return(
        can_reach_LMF_boss_door(state, player)
        and state.has("Gust Bellows", player) and state.has("Bomb Bag", player) # Bombs uncover statues
        and can_defeat_beamos(state, player) and can_defeat_armos(state, player)
        and (has_practice_sword(state, player) or distance_activator(state, player)) # Hit crystals
    )
...
def can_beat_LMF(state: CollectionState, player: int) -> bool:
    return(
        can_beat_moldarach(state, player)
        and (has_beetle(state, player) or has_bow(state, player)) # To hit the timeshift stone
    )
...
def can_lower_AC_statue(state: CollectionState, player: int) -> bool:
    return(
        can_reach_AC_vines(state, player) and state.has("Whip", player)
    )
...
def can_reach_AC_boko_key_door(state: CollectionState, player: int) -> bool:
    return(
        ...
        and state.has("Whip", player) and state.has("Water Dragon's Scale", player)
...
def can_reach_AC_vines(state: CollectionState, player: int) -> bool:
    return(
        ...
        and (
            ...
            or (can_reach_AC_boko_key_door(state, player) and state.has("Ancient Cistern Small Key", player, 2))
        )
    )
...
def can_change_SSH_temporality(state: CollectionState, player: int) -> bool:
    return(
        ...
        and (has_practice_sword(state, player) or state.has("Sandship Small Key", player, 2))
    )
...
def can_beat_tentalus(state: CollectionState, player: int) -> bool:
    return(
        ...
        and state.has("Sandship Boss Key", player) and has_bow(state, player)
    )
...
def can_reach_FS_water_pod_room(state: CollectionState, player: int) -> bool:
    return(
        ...
        and has_hook_beetle(state, player) and state.has("Fire Sanctuary Small Key", player, 2)
    )
...
def can_reach_FS_second_bridge(state: CollectionState, player: int) -> bool:
    return(
        ...
        and has_practice_sword(state, player)
        and has_mogma_mitts(state, player) and state.has("Gust Bellows", player)
    )
...
def can_reach_FS_plats_room(state: CollectionState, player: int) -> bool:
    return(
        can_reach_FS_water_pod_room(state, player)
        and has_practice_sword(state, player)
        and has_mogma_mitts(state, player) and state.has("Fire Sanctuary Small Key", player, 3)
        and (distance_activator(state, player) or state.has("Bomb Bag", player)) # for water pod
    )
...
def can_reach_top_of_FS_staircase(state: CollectionState, player: int) -> bool:
    return(
        ...
        and can_defeat_lezalfos(state, player) and state.has("Clawshots", player)
    )

def can_beat_ghirahim_2(state: CollectionState, player: int) -> bool:
    return(
        can_reach_FS_boss_door(state, player)
        and state.has("Fire Sanctuary Boss Key", player) and has_practice_sword(state, player)
    )
...
def can_pass_SK_sv_room(state: CollectionState, player: int) -> bool:
    return(
        ...
        and state.has("Whip", player)
        and state.has("Clawshots", player)
        and (state.has("Bomb Bag", player) or has_hook_beetle(state, player) or has_bow(state, player))
        and state.has("Gust Bellows", player)
    )
...
def can_pass_SK_mini_boss_room(state: CollectionState, player: int) -> bool:
    return(
        ...
        and has_practice_sword(state, player) and state.has("Clawshots", player)
    )
...
def can_pass_SK_fs_room(state: CollectionState, player: int) -> bool:
    return(
        can_pass_SK_ac_room(state, player)
        and has_beetle(state, player) and state.has("Clawshots", player)
    )
...
def can_pass_SK_ssh_room(state: CollectionState, player: int) -> bool:
    return(
        ...
        and has_bow(state, player) and state.has("Clawshots", player)
    )
